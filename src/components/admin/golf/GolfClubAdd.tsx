...
const GolfClubAdd = ({setOpenGolfClubAdd, brand}: IGolfClubProps): JSX.Element => {
        ...
        <div className={style.container}>
            ...
            <div className={style.golfClub_name_box}>
                ...
                <div className={style.input_box}>
                    ...
                    <textarea className={style.textarea} name='description' value={description}
            ...
            <div className={style.input_box}>
                ...
                <div className={style.img_input_box}>
                    ...
                    <input className={style.hidden} id='img' type='file' accept="image/jpeg, image/png"
            ...
            <div className={style.input_box}>
                ...
                <div className={style.sub_input_container}>
                    <div className={style.sub_input_box}>
                        ...
                        <input className={style.sub_input} type='number' name='year' value={year}
                               onChange={handleChangeInputs}/>
                        <span>년</span>
                    </div>
                    <div className={style.sub_input_box}>
                        <span className={style.sub_input_txt}>가격</span>
                        <input className={style.sub_input} type='number' name='cost' value={cost}
                               onChange={handleChangeInputs}/>
                        <span>원</span>
                    </div>
                    <div className={style.sub_input_box}>
                        <span className={style.sub_input_txt}>성별</span>
                        <input className={style.radio_input} type='radio' name='gender' value='MALE'
                               onChange={handleChangeInputs}/>
                        <span className={style.radio_txt}>남성</span>
                        <input className={style.radio_input} type='radio' name='gender' value='FEMALE'
                               onChange={handleChangeInputs}/>
                        <span className={style.radio_txt}>여성</span>
                    </div>
                    <div className={style.sub_input_box}>
                        <span className={style.sub_input_txt}>face</span>
                        <input className={style.sub_input} type='number' name='face' value={face}
                               onChange={handleChangeInputs}/>
                    </div>
                    <div className={style.sub_input_box}>
                        <span className={style.sub_input_txt}>shaft</span>
                        <input className={style.sub_input} type='number' name='shaft' value={shaft}
                               onChange={handleChangeInputs}/>
                    </div>
                    <div className={style.sub_input_box}>
                        <span className={style.sub_input_txt}>sound</span>
                        <input className={style.sub_input} type='number' name='sound' value={sound}
                               onChange={handleChangeInputs}/>
                    </div>
                    <div className={style.sub_input_box}>
                        <span className={style.sub_input_txt}>shooting</span>
                        <input className={style.sub_input} type='number' name='shooting' value={shooting}
                               onChange={handleChangeInputs}/>
                    </div>
                </div>
            </div>
