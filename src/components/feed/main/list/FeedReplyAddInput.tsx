...
const FeedReplyAddInput = ({feedId, feedUser, refId, refUser}: IFeedReplyAddProps): JSX.Element => {
    ...
    return (
        <div className={style.form}>
            <textarea value={replyPayload} onChange={handleChangeTextArea} onKeyPress={handleTextAreaKeyPress}
                      className={style.input} placeholder={"댓글을 달아보세요!"} ref={textAreaRef}/>
        </div>
    );
};
