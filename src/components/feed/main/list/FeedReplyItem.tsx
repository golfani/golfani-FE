            ...
            <div className={style.reply_content_box} ref={ref}>
                ...
                <div className={style.bottom_box}>
                    ...
                    {userIsReplyLikesQuery.data?.likes
                        ?
                        <FavoriteIcon onClick={handleClickLikes} style={{fontSize: '15px'}} className={style.like_icon}
                                      color={'error'}/>
                        : <FavoriteBorderOutlinedIcon onClick={handleClickLikes} style={{fontSize: '15px'}}
                                                      className={style.like_icon} color={'error'}/>
                    }
                ...
                {isReplyAdd
                    ...
                    <div className={style.reply_add_box}>
                        <FeedReplyAddInput feedId={reply.feedId!} refId={reply.referenceId || reply.id}
