    ...
    return (
        <div className={style.container}>
            <Head>
                ...
                <meta property="og:title" name="og:title" content="골아니 비밀번호 찾기"/>
                <meta property="og:description" name="og:description" content="골아니 비밀번호 찾기 페이지 입니다."/>
                <meta property="og:url" name="og:url" content="https://golfani.com/findPw"/>
            </Head>
