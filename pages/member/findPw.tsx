    ...
    return (
        <div className={style.container}>
            <Head>
                ...
                <meta property="og:title" key="ogtitle" content="골아니 비밀번호 찾기"/>
                <meta property="og:description" key="ogdesc" content="골아니 비밀번호 찾기 페이지 입니다."/>
                <meta property="og:url" key="ogurl" content="https://golfani.com/findPw"/>
            </Head>
